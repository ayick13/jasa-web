  ...
  return (
    <div className="max-w-2xl mx-auto py-16 px-4 text-slate-900 dark:text-slate-100">
      ...
      <ol className="list-decimal ml-6 mb-4">
        <li>Kirim email ke <a href="mailto:ayicktigabelas@gmail.com" className="text-cyan-500 underline">ayicktigabelas@gmail.com</a> dengan subjek "Permintaan Penghapusan Data".</li>
