        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
             <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center md:items-start gap-12 md:gap-16">
                <div className="w-full md:w-1/3 flex-shrink-0 flex justify-center">
                    <Image src="https://placehold.co/400x400/1e293b/93c5fd?text=AY" alt="Foto profil Ayick" width={256} height={256} className="rounded-full shadow-2xl shadow-cyan-500/20 border-4 border-slate-200 dark:border-slate-700" />
                </div>
