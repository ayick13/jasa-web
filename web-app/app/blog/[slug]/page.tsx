...
const BlogCTA = () => (
    <div className="mt-16 bg-slate-800 border border-slate-700 rounded-xl p-8 text-center">
        ...
        <Link href="/#contact" className="inline-flex items-center justify-center gap-2 bg-cyan-500 text-white font-bold py-3 px-8 rounded-full shadow-lg shadow-cyan-500/30 hover:bg-cyan-600 transition-all duration-300 transform hover:scale-105">
