...
import { Home, Rss, Mail, Code, Briefcase } from 'lucide-react'; // Impor Briefcase
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-20">
            ...
            <nav className="flex items-center space-x-4 md:space-x-6">
              ...
              <Link href="/proyek" className="flex items-center gap-2 text-slate-600 dark:text-slate-300 hover:text-slate-900 dark:hover:text-cyan-400 transition-colors">
